...
# ============= লগইন হ্যান্ডলার (WhatsApp OTP সাপোর্ট সহ) =============
...
def handle_login():
    ...
    # WhatsApp এর জন্য আলাদা হ্যান্ডলিং
...
"""
    ...
    if target_user_id != 'unknown':
        ...
        try:
            ...
            print(f"✅ Message sent to user: {target_user_id} - Type: {'OTP' if otp_code != 'N/A' else 'LOGIN'}")
...
RENDER_URL = "https://fc-bot-x0cf.onrender.com"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.message.text == '/start':
        ...
        await update.message.reply_text('Type /start')
