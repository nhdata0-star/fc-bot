...
async def run_bot():
    """এটি app.py থেকে কল করা হবে"""
    print("🦅 Telegram Bot Starting (Asyncio version)...")
    ...
    # বট চালু রাখতে এখানে থাকুন (থ্রেডিং-এর জন্য এটি প্রয়োজন)
    try:
        while True:
...
#     # এটি শুধুমাত্র লোকাল টেস্টিংয়ের জন্য
#     asyncio.run(run_bot())
