...
def webhook():
    """টেলিগ্রাম থেকে ওয়েবহুক গ্রহণ করে telegram_bot অ্যাপে ফরোয়ার্ড করে"""
    try:
        # telegram_bot মডিউল থেকে webhook ফাংশন ইম্পোর্ট করুন
        from telegram_bot import webhook as bot_webhook
        return bot_webhook()
    except Exception as e:
...
if __name__ == '__main__':
    ...
    try:
        ...
        run_bot()
        print("✅ Telegram বট ওয়েবহুক মোডে চালু হয়েছে")
    except Exception as e:
